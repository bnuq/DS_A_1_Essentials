...
/*
Main Problem = Recursive Case + Base Case, 큰 문제를 작은 문제로 쪼개서 생각
...
Recursion 에서는 현재 단계 작업과 sub problem 작업 중, 무엇을 먼저할 지 순서를 설정하는 게
매우매우 중요하다
*/
...
// 2중 루프문은 하나의 Recursion function 으로 대체할 수 있다
